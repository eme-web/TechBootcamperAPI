...
exports.getBootcamps = asyncHandler(async(req, res, next) => {
    ...
    res.status(200).json({success: true,data: bootcamp, msg: "show all bootcamps"});
...
exports.getBootcamp = asyncHandler(async(req, res, next) => {
    ...
    res.status(200).json({success: true, data:bootcamp, msg: "show bootcamp"});
});
...
exports.updateBootcamp = asyncHandler(async(req, res, next) => {
    ...
    let bootcamp = await Bootcamp.findById({_id: id});
    ...
    bootcamp = await Bootcamp.findByIdAndUpdate({_id: id },
      { $set: {...body } }, { new: true });
